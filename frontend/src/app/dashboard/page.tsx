  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto pb-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        {metrics.map((m, idx) => (
          <div key={idx} data-theme-card="light" className="glassmorphism rounded-2xl p-6 border border-surface-4 shadow-card hover:border-brand-lime/20 transition-all">
      ...
      <div data-theme-card="light" className="glassmorphism rounded-2xl border border-surface-4 p-6 flex flex-col min-w-0">
        ...
        {/* Silver Oak Campus Map */}
        <div data-theme-card="dark" className="glassmorphism rounded-2xl border border-surface-4 p-6 space-y-4">
